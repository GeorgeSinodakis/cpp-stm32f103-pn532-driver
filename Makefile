...
FLAGS = -O0 -mcpu=cortex-m3 -mthumb -fpermissive -ffunction-sections -fdata-sections -u _printf_float -lc -lm -mfloat-abi=soft -lstdc++ -lsupc++ --specs=nosys.specs -static
